...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetWeather xmlns=""http://www.webserviceX.NET""><CityName>Fort Worth</CityName><CountryName>United States</CountryName></GetWeather></Body></Envelope>");
            ...
            _flow.StServiceCallActivity4.Name = @"GetWeather";
            _flow.StServiceCallActivity4.TransportProtocol.SOAPProperties.EndpointAddress = String.IsNullOrEmpty(_context.ResourceManager.GetValue(@"{Step.GeneralProperties.StServiceCallActivity4.TransportProtocol.SOAPProperties.EndpointAddress}")) ? @"http://www.webservicex.com/globalweather.asmx" : _context.ResourceManager.GetValue(@"{Step.GeneralProperties.StServiceCallActivity4.TransportProtocol.SOAPProperties.EndpointAddress}");
            _flow.StServiceCallActivity4.TransportProtocol.SOAPProperties.SoapAction = @"http://www.webserviceX.NET/GetWeather";
            ...
            _flow.StServiceCallActivity4.Service = @"GlobalWeather";
            _flow.StServiceCallActivity4.Port = @"GlobalWeatherSoap";
            _flow.StServiceCallActivity4.Operation = @"GetWeather";
            ...
            _flow.StServiceCallActivity4.TargetNamespace=@"http://www.webserviceX.NET";
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetWeatherResponse xmlns=""http://www.webserviceX.NET"" /></Body></Envelope>");
